...
public class Ex3 {
	static SixTuple<Robot3, Vehicle, Amphibian, String, Integer, Double> f() {
		return new SixTuple<Robot3, Vehicle, Amphibian, String, Integer, Double>( 
		new Robot3(), new Vehicle(), new Amphibian(), "hi", 47, 11.1);
	}
	public static void main(String[] args) {
		SixTuple<Robot3, Vehicle, Amphibian, String, Integer, Double> st = f();
